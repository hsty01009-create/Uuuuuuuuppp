...
def set_registered(user_id, value):
    return update_user_field(user_id, "registered", int(value))


def set_accepted_rules(user_id, value):
    return update_user_field(user_id, "accepted_rules", int(value))


def set_first_start(user_id, value):
    return update_user_field(user_id, "first_start", int(value))


def set_invited_by(user_id, inviter):
    return update_user_field(user_id, "invited_by", inviter)
